...
//	short Temp;
  ...
  while(1)
  {
	...
	if(Ang.Angley_dat > (0.0) && Ang.Angley_dat <= (15.0))
	{
		ws281x_colorWipe(ws281x_color(0, 10, 10), 15);
		printf("\r\n angley dat :   %f\r\n", Ang.Angley_dat);
		printf("\r\n angle dat :   %f\r\n", Ang.Angle_dat);
		// printf("angley dat :   %f \r\n", Ang.Angley_dat);
		printf("\r\n");
	...
	else if(Ang.Angley_dat > (-15.0) && Ang.Angley_dat <= (0.0))
	{
	...
	else if(Ang.Angley_dat > (-30.0) && Ang.Angley_dat <= (0.0))
	{
		ws281x_colorWipe(ws281x_color(10, 0, 0), 15);
		printf("\r\n angley dat :   %f\r\n", Ang.Angley_dat);
		// printf("angley dat :   %f \r\n", Ang.Angley_dat);
		printf("\r\n");
		printf("\r\n");
